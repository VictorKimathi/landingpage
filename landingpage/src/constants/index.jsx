export const features = [
  {
    ...
    caption: "Personalized Financial Advice",
    title: "Tailored Insights for Your Financial Goals",
    text: "Our AI advisor analyzes your spending habits, investment preferences, and financial goals to provide real-time, personalized recommendations. Optimize your wealth-building strategies with precision and ease.",
    button: {
  ...
  },
  {
    ...
    title: "Your Financial Data, Protected",
    text: "We employ industry-leading security protocols and are fully compliant with financial regulations, ensuring your sensitive data is always safe. Your privacy is our top priority, allowing you to make decisions confidently.",
    button: {
...
export const details = [
  ...
  },
  {
    ...
    title: "Collaborate with Your Financial Advisor",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    title: "24/7 Financial Planning Support",
  },
];
...
export const plans = [
  {
    id: "0",
    title: "Free",
    priceMonthly: 0, // Free plan
    priceYearly: 0,
    caption: "Ideal for individuals exploring AI financial advice",
    features: [
  ...
  },
  {
    ...
    priceMonthly: 19,
    priceYearly: 12,
    caption: "Best for solo investors and small businesses",
    features: [
  ...
  },
  {
    ...
    priceMonthly: 79,
    priceYearly: 59,
    caption: "Most popular for financial professionals",
    features: [
      "All Core features",
  ...
  },
  {
    ...
    priceMonthly: 39,
    priceYearly: 29,
    caption: "Best for teams and financial firms",
    features: [
      "All Overdrive features",
      "Collaborative financial planning",
      "10TB additional data storage",
      "Admin control for multiple users",
      "Custom AI financial strategies",
    ],
